...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Iox features */
        {"iox", "masternode", &masternode, true, true, false},
        {"iox", "listmasternodes", &listmasternodes, true, true, false},
        {"iox", "getmasternodecount", &getmasternodecount, true, true, false},
        {"iox", "masternodeconnect", &masternodeconnect, true, true, false},
        {"iox", "masternodecurrent", &masternodecurrent, true, true, false},
        {"iox", "masternodedebug", &masternodedebug, true, true, false},
        {"iox", "startmasternode", &startmasternode, true, true, false},
        {"iox", "createmasternodekey", &createmasternodekey, true, true, false},
        {"iox", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"iox", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"iox", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"iox", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"iox", "getmasternodescores", &getmasternodescores, true, true, false},
        {"iox", "mnbudget", &mnbudget, true, true, false},
        {"iox", "preparebudget", &preparebudget, true, true, false},
        {"iox", "submitbudget", &submitbudget, true, true, false},
        {"iox", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"iox", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"iox", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"iox", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"iox", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"iox", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"iox", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"iox", "checkbudgets", &checkbudgets, true, true, false},
        {"iox", "mnsync", &mnsync, true, true, false},
        {"iox", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> iox-cli " + methodname + " " + args + "\n";
}
