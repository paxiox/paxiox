                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Iox Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IOX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and iox: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Iox Core"), this);
    aboutAction->setStatusTip(tr("Show information about Iox Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Iox"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IOX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IOX addresses"));
    ...
    openAction->setStatusTip(tr("Open a iox: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Iox Core help message to get a list with possible Iox command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Iox Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Iox network", "", count));
}
...
{
    QString strTitle = tr("Iox Core"); // default title
