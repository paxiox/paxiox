...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(IOX);
    unitlist.append(mIOX);
    unitlist.append(uIOX);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case IOX:
            return QString("tIOX");
        case mIOX:
            return QString("mtIOX");
        case uIOX:
            return QString::fromUtf8("μtIOX");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case IOX:
            return QString("IOX");
        case mIOX:
            return QString("Milli-IOX (1 / 1" THIN_SP_UTF8 "000)");
        case uIOX:
            return QString("Micro-IOX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case IOX:
            return QString("TestIOXs");
        case mIOX:
            return QString("Milli-TestIOX (1 / 1" THIN_SP_UTF8 "000)");
        case uIOX:
            return QString("Micro-TestIOX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
