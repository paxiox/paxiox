Contributing to Iox Core
==================================

The Iox Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Iox Core project, and is not to be
confused with overall Iox Network Protocol consensus changes.

Whether a pull request is merged into Iox Core rests with the project merge
...
Patches that change Iox consensus rules are considerably more involved than
...
Where a patch set proposes to change the Iox consensus, it must have been
...
The project leader is the release manager for each Iox Core release.
